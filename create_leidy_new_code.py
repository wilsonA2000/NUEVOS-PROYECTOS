...
def create_leidy_new_code():
    """Crear código de entrevista para letefon00@gmail.com"""
    
    # Datos del candidato arrendador
    candidate_data = {
        'candidate_name': 'Leidy Fonseca',
        'candidate_email': 'letefon00@gmail.com',
...
if __name__ == '__main__':
    print('🔑 CREANDO CÓDIGO DE ENTREVISTA PARA letefon00@gmail.com')
    print('=' * 55)
    
    try:
        code_obj = create_leidy_new_code()
