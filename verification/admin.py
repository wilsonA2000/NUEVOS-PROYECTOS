...
class VerificationAgentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Disponibilidad",
            {"fields": ("is_available", "max_weekly_visits", "availability_notes")},
        ),
        (
            "Métricas",
            {"fields": ("total_visits_completed", "average_rating", "hired_at")},
        ),
...
class VerificationVisitAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Resultado",
            {"fields": ("verification_passed", "agent_notes", "cancellation_reason")},
        ),
        ("Sistema", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
