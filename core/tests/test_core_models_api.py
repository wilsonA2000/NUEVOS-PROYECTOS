...
class ContactMessageModelTests(TestCase):
    ...
    def test_create_contact_message(self):
        msg = ContactMessage.objects.create(
            ...
            message="Quiero informacion sobre VeriHome",
        )
...
class SupportTicketModelTests(TestCase):
    ...
    def test_auto_generated_ticket_number(self):
        ticket = SupportTicket.objects.create(
            ...
            subject="Problema con contrato",
            description="No puedo firmar",
            category="contract",
        )
...
class FAQAPITests(APITestCase):
    ...
    def setUp(self):
        FAQ.objects.create(
            category="general",
            question="Que es VeriHome?",
            answer="Una plataforma inmobiliaria.",
            is_published=True,
        )
        FAQ.objects.create(
            category="payments",
            question="Metodos de pago?",
            answer="PSE, Nequi, tarjetas.",
            is_published=True,
        )
        FAQ.objects.create(
            category="general",
