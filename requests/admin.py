...
class BaseRequestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Usuarios", {"fields": ("requester", "assignee")}),
        ("Estado", {"fields": ("status", "priority", "due_date", "completed_at")}),
        ("Respuesta", {"fields": ("response_message", "response_date")}),
...
class TenantDocumentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Proceso y Usuario", {"fields": ("property_request", "uploaded_by")}),
        (
            "Revisión",
            {"fields": ("status", "reviewed_by", "review_notes", "reviewed_at")},
        ),
        ("Fechas", {"fields": ("uploaded_at", "updated_at")}),
    )
