...
class ContractTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Contenido", {"fields": ("content", "variables"), "classes": ("wide",)}),
        (
            "Metadatos",
            {
...
class ContractAmendmentInline(admin.TabularInline):
    ...
    fields = ["title", "status", "requested_by", "approved_by", "created_at"]
...
class ContractAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "contract_number",
        "title",
        "primary_party__email",
        "secondary_party__email",
        "property__title",
    ]
    readonly_fields = [
        "contract_number",
    ...
    fieldsets = (
        ...
        (
            "Contenido",
            {"fields": ("content", "variables_data"), "classes": ("collapse",)},
        ),
        (
            "Archivo PDF",
            {
    ...
    def mark_as_active(self, request, queryset):
        ...
        updated = queryset.filter(status="fully_signed").update(status="active")
...
class EditableContractClauseAdmin(_ClauseAdminBase):
    ...
    fieldsets = (
        ("Identificación", {"fields": ("clause_number", "ordinal_text", "title")}),
        (
    ...
    def variable_helper(self, obj):
        ...
        html_parts.append(
            "<strong>Variables Disponibles (click para copiar):</strong><br><br>"
        )
    ...
    class Media:
        css = {"all": ["admin/css/clause_admin.css"]}
...
class ContractTypeTemplateAdmin(admin.ModelAdmin):
    ...
    def mark_as_reviewed(self, request, queryset):
        ...
        self.message_user(
            request, f"{queryset.count()} plantillas marcadas como revisadas."
        )
