...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/firmas/", views.ContractSignaturesView.as_view(), name="signatures"
    ),
    path(
        "<uuid:pk>/verificar-firmas/",
        views.VerifySignaturesView.as_view(),
        name="verify_signatures",
    ),
    # Enmiendas y modificaciones
    path(
        "<uuid:pk>/enmienda/",
        views.CreateAmendmentView.as_view(),
        name="create_amendment",
    ),
    path("<uuid:pk>/enmiendas/", views.AmendmentListView.as_view(), name="amendments"),
    path(
        "enmienda/<int:amendment_pk>/",
        views.AmendmentDetailView.as_view(),
        name="amendment_detail",
    ),
    path(
        "enmienda/<int:amendment_pk>/aprobar/",
        views.ApproveAmendmentView.as_view(),
        name="approve_amendment",
    ),
    path(
        "enmienda/<int:amendment_pk>/rechazar/",
        views.RejectAmendmentView.as_view(),
    ...
    path(
        "renovacion/<int:renewal_pk>/",
        views.RenewalDetailView.as_view(),
        name="renewal_detail",
    ),
    path(
        "renovacion/<int:renewal_pk>/aprobar/",
        views.ApproveRenewalView.as_view(),
        name="approve_renewal",
    ),
    path(
        "renovacion/<int:renewal_pk>/rechazar/",
        views.RejectRenewalView.as_view(),
        name="reject_renewal",
    ),
    # Terminación de contratos
    path(
        "<uuid:pk>/terminar/", views.TerminateContractView.as_view(), name="terminate"
    ),
    path(
        "<uuid:pk>/terminacion/",
        views.TerminationDetailView.as_view(),
        name="termination_detail",
    ),
    path(
        "terminacion/<int:termination_pk>/aprobar/",
        views.ApproveTerminationView.as_view(),
        name="approve_termination",
    ),
    # Documentos del contrato
    path(
        "<uuid:pk>/documentos/", views.ContractDocumentsView.as_view(), name="documents"
    ),
    path(
        "<uuid:pk>/documentos/subir/",
        views.UploadDocumentView.as_view(),
        name="upload_document",
    ),
    path(
        "documento/<int:document_pk>/",
        views.DocumentDetailView.as_view(),
        name="document_detail",
    ),
    path(
        "documento/<int:document_pk>/eliminar/",
    ...
    path(
        "<uuid:pk>/preview-pdf/",
        views.DownloadContractPDFView.as_view(),
        name="preview_pdf",
    ),
    path(
        "<uuid:pk>/descargar-pdf/",
        views.DownloadContractPDFView.as_view(),
        name="download_pdf",
    ),
    ...
    path(
        "<uuid:pk>/recordatorios/",
        views.ContractRemindersView.as_view(),
        name="reminders",
    ),
    path(
        "<uuid:pk>/notificaciones/",
        views.ContractNotificationsView.as_view(),
        name="notifications",
    ),
    # Reportes
    ...
    path(
        ...
        views.ExpiringContractsReportView.as_view(),
        name="expiring_contracts",
    ),
    path(
        "reportes/pendientes-firma/",
        views.PendingSignatureReportView.as_view(),
