...
def test_selective_update():
    ...
    try:
        ...
        serializer = UserProfileSerializer(
            instance=test_user, data=update_data_1, partial=True
        )
        ...
        update_data_2 = {"current_address": "", "employer_name": "", "job_title": ""}

        serializer = UserProfileSerializer(
            instance=updated_user, data=update_data_2, partial=True
        )
        ...
        serializer = UserProfileSerializer(
            instance=updated_user, data=update_data_3, partial=True
        )
        ...
        serializer = UserProfileSerializer(
            instance=updated_user, data=update_data_4, partial=True
        )
...
def test_completion_percentage():
    ...
    for test_case in test_cases:
        percentage = calculate_completion_percentage(
            test_case["data"], test_case["user_type"]
        )
