...
class PropertyModelTestCase(TestCase):
    ...
    def test_property_images_relationship(self):
        ...
        image1 = PropertyImage.objects.create(
            property=property_obj, image="path/to/image1.jpg", is_main=True
        )
        PropertyImage.objects.create(
            property=property_obj, image="path/to/image2.jpg", is_main=False
        )
...
class PaymentModelTestCase(TestCase):
    ...
    def test_payment_string_representation(self):
        ...
        expected_str = (
            f"Payment {payment.id} - {payment.amount} ({payment.payment_type})"
        )
