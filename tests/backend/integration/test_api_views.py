...
class PropertyAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.property_detail_url = reverse(
            "api:properties-detail", kwargs={"pk": self.property.pk}
        )
...
class ContractAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.contract_detail_url = reverse(
            "api:contracts-detail", kwargs={"pk": self.contract.pk}
        )
    ...
    def test_sign_contract_as_tenant(self):
        ...
        self.assertTrue(self.contract.signatures.filter(signer=self.tenant).exists())
...
class PaymentAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.payment_detail_url = reverse(
            "api:payments-detail", kwargs={"pk": self.payment.pk}
        )
...
class RatingAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.rating_detail_url = reverse(
            "api:ratings-detail", kwargs={"pk": self.rating.pk}
        )
...
class MessageAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.conversation = Conversation.objects.create(
            subject="Property Inquiry", created_by=self.user1
        )
    ...
    def test_get_conversation_messages(self):
        ...
        self.assertEqual(len(response.data["results"]), 1)
        self.assertEqual(
            response.data["results"][0]["conversation"], self.conversation.id
        )
    ...
    def test_mark_message_as_read(self):
        ...
        mark_read_url = reverse(
            "api:messages-mark-read", kwargs={"pk": self.message.pk}
        )
