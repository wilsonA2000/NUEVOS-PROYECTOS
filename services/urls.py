...
from .api_views import (
    ...
    PopularServicesListView,
    FeaturedServicesListView,
    MostRequestedServicesListView,
    ServicesByCategoryListView,
    ServiceSearchView,
...
urlpatterns = [
    ...
    path(
        "most-requested/",
        MostRequestedServicesListView.as_view(),
        name="most-requested-services",
    ),
    path(
        "category/<slug:category_slug>/",
        ServicesByCategoryListView.as_view(),
