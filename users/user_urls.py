...
urlpatterns = [
    ...
    path(
        "activity/history/", user_views.user_activity_history, name="activity_history"
    ),
    path(
        "activity/<int:activity_id>/",
        user_views.activity_detail,
        name="activity_detail",
    ),
    # Acciones administrativas
    path("admin-actions/", user_views.admin_actions_on_user, name="admin_actions"),
    path(
        "admin-actions/<int:action_id>/",
        user_views.admin_action_detail,
    ...
    path(
        ...
        user_views.impersonation_history,
        name="impersonation_history",
    ),
    # APIs
    path(
        "api/activity-summary/",
        user_views.api_user_activity_summary,
        name="api_activity_summary",
    ),
    path(
        "api/notifications/",
        user_views.api_user_notifications,
        name="api_notifications",
    ),
    path(
        "api/admin-actions/",
        user_views.api_admin_actions_on_user,
        name="api_admin_actions",
    ),
    path(
        "api/notifications/<int:notification_id>/read/",
        user_views.api_mark_notification_read,
