...
class UserResume(models.Model):
    ...
    emergency_contact_name = models.CharField(
        "Contacto de emergencia", max_length=200, blank=True
    )
    emergency_contact_phone = models.CharField(
        "Teléfono de emergencia", max_length=15, blank=True
    )
    emergency_contact_relation = models.CharField(
        "Relación", max_length=100, blank=True
    )
    emergency_contact_address = models.CharField(
        "Dirección de emergencia", max_length=255, blank=True
    )

    # Información educativa
    education_level = models.CharField(
        "Nivel educativo", max_length=20, choices=EDUCATION_LEVELS, blank=True
    )
    institution_name = models.CharField(
        "Nombre de la institución", max_length=200, blank=True
    )
    field_of_study = models.CharField("Campo de estudio", max_length=200, blank=True)
    graduation_year = models.PositiveIntegerField(
        "Año de graduación", null=True, blank=True
    )
    gpa = models.DecimalField(
        "Promedio", max_digits=3, decimal_places=2, null=True, blank=True
    )
    ...
    employment_type = models.CharField(
        "Tipo de empleo", max_length=20, choices=EMPLOYMENT_TYPES, blank=True
    )
    ...
    monthly_salary = models.DecimalField(
        "Salario mensual", max_digits=12, decimal_places=2, null=True, blank=True
    )
    supervisor_name = models.CharField(
        "Nombre del supervisor", max_length=200, blank=True
    )
    supervisor_phone = models.CharField(
        "Teléfono del supervisor", max_length=15, blank=True
    )
    ...
    credit_score = models.PositiveIntegerField(
        "Puntuación crediticia", null=True, blank=True
    )
    monthly_expenses = models.DecimalField(
        "Gastos mensuales", max_digits=12, decimal_places=2, null=True, blank=True
    )

    # Referencias personales
    reference1_name = models.CharField(
        "Referencia 1 - Nombre", max_length=200, blank=True
    )
    reference1_phone = models.CharField(
        "Referencia 1 - Teléfono", max_length=15, blank=True
    )
    reference1_email = models.EmailField("Referencia 1 - Email", blank=True)
    reference1_relation = models.CharField(
        "Referencia 1 - Relación", max_length=100, blank=True
    )

    reference2_name = models.CharField(
        "Referencia 2 - Nombre", max_length=200, blank=True
    )
    reference2_phone = models.CharField(
        "Referencia 2 - Teléfono", max_length=15, blank=True
    )
    reference2_email = models.EmailField("Referencia 2 - Email", blank=True)
    reference2_relation = models.CharField(
        "Referencia 2 - Relación", max_length=100, blank=True
    )

    # Historial de vivienda
    previous_addresses = models.JSONField(
        "Direcciones anteriores", default=list, blank=True
    )
    ...
    id_document = models.FileField(
        "Documento de identificación", upload_to="resume/id/", null=True, blank=True
    )
    id_document_status = models.CharField(
        "Estado del documento de ID",
        max_length=20,
    ...
    proof_of_income = models.FileField(
        "Comprobante de ingresos", upload_to="resume/income/", null=True, blank=True
    )
    proof_of_income_status = models.CharField(
        "Estado del comprobante de ingresos",
        max_length=20,
        choices=DOCUMENT_STATUS,
        default="pending",
    )
    ...
    bank_statement = models.FileField(
        "Estado de cuenta bancario", upload_to="resume/bank/", null=True, blank=True
    )
    bank_statement_status = models.CharField(
    ...
    employment_letter = models.FileField(
        "Carta laboral", upload_to="resume/employment/", null=True, blank=True
    )
    employment_letter_status = models.CharField(
        "Estado de la carta laboral",
        max_length=20,
        choices=DOCUMENT_STATUS,
        default="pending",
    )
    ...
    tax_return = models.FileField(
        "Declaración de impuestos", upload_to="resume/tax/", null=True, blank=True
    )
    tax_return_status = models.CharField(
    ...
    credit_report = models.FileField(
        "Reporte crediticio", upload_to="resume/credit/", null=True, blank=True
    )
    credit_report_status = models.CharField(
        "Estado del reporte crediticio",
        max_length=20,
        choices=DOCUMENT_STATUS,
        default="pending",
    )
    ...
    criminal_record_details = models.TextField(
        "Detalles de antecedentes penales", blank=True
    )
    criminal_record_document = models.FileField(
        "Documento de antecedentes penales",
        upload_to="resume/criminal/",
        null=True,
        blank=True,
    )
    ...
    verification_score = models.PositiveIntegerField(
        "Puntuación de verificación", default=0
    )
