...
class User(AbstractUser):
    ...
    verification_date = models.DateTimeField(
        "Fecha de verificación", null=True, blank=True
    )
    ...
    marketing_consent = models.BooleanField(
        "Consentimiento de marketing", default=False
    )
    ...
    hourly_rate = models.DecimalField(
        "Tarifa por hora", max_digits=10, decimal_places=2, null=True, blank=True
    )
