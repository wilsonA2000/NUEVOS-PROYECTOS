...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ("Verificación", {"fields": ("is_verified", "verification_date")}),
        (
            "Permisos",
            {
                "fields": (
...
class PortfolioItemAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "title",
        "description",
        "service_provider__user__first_name",
        "service_provider__user__last_name",
    ]
    ...
    fieldsets = (
        ...
        ("Detalles", {"fields": ("project_date", "client_name", "project_cost")}),
    )
...
class EmailConfirmationAdmin(admin.ModelAdmin):
    ...
    list_display = ["key", "email_address", "created", "sent", "is_expired"]
