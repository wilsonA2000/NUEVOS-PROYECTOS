...
function buildSettingsActions(): AuditAction[] {
  ...
  return [
    ...
    // Switches por label (toggle alterna el estado)
    {
      ...
      selector: { label: /notificaciones por email/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    {
      name: 'toggle-sms-notifications',
      selector: { label: /notificaciones por sms/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    {
      name: 'toggle-newsletter',
      selector: { label: /^newsletter$/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    {
      name: 'toggle-property-alerts',
      selector: { label: /alertas de propiedades/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    {
      name: 'toggle-message-notifications',
      selector: { label: /notificaciones de mensajes/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    {
      name: 'toggle-payment-reminders',
      selector: { label: /recordatorios de pagos/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    ...
    {
      name: 'toggle-2fa',
      selector: { label: /autenticaci[oó]n de dos factores|2fa/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
    {
      name: 'toggle-login-notifications',
      selector: { label: /notificaciones de inicio de sesi[oó]n/i },
      kind: 'toggle',
      skipIfNotFound: true,
    },
