...
const ResumeEdit: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showNotification(
        `Error al guardar la hoja de vida: ${err.response?.data?.error || err.message}`,
        'error',
      );
    } finally {
      setSaving(false);
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('dependents', parseInt(e.target.value) || 0)
                  }
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={4}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('supervisorEmail', e.target.value)
                  }
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('reference1Phone', e.target.value)
                  }
                  inputProps={{ maxLength: 15 }}
                />
              </Grid>
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('reference1Email', e.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('reference1Relation', e.target.value)
                  }
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('reference2Phone', e.target.value)
                  }
                  inputProps={{ maxLength: 15 }}
                />
              </Grid>
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('reference2Email', e.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  onChange={e =>
                    handleChange('reference2Relation', e.target.value)
                  }
                />
              </Grid>
            </Grid>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={e =>
                        handleChange('evictionHistory', e.target.checked)
                      }
                    />
                  }
              ...
              {formData.evictionHistory && (
                <Grid item xs={12}>
                  <TextField
                    ...
                    onChange={e =>
                      handleChange('evictionDetails', e.target.value)
                    }
                  />
                </Grid>
              )}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={e =>
                        handleChange('criminalRecord', e.target.checked)
                      }
                    />
                  }
              ...
              {formData.criminalRecord && (
                <Grid item xs={12}>
                  <TextField
                    ...
                    onChange={e =>
                      handleChange('criminalRecordDetails', e.target.value)
                    }
                  />
                </Grid>
              )}
