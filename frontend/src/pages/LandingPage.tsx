...
const SectionTitle: React.FC<{
  ...
  <Box sx={{ textAlign: 'center', mb: 6 }}>
    ...
    {subtitle && (
      <Typography
        variant='body1'
        sx={{ color: 'text.secondary', maxWidth: 600, mx: 'auto', mt: 1 }}
      >
        {subtitle}
      </Typography>
    )}
...
const ScrollRevealBox: React.FC<{
  children: React.ReactNode;
  delay?: number;
  type?: 'fade' | 'grow';
}> = ({ children, delay = 0, type = 'fade' }) => {
  ...
  const features = [
    {
      ...
      description:
        'Administra propiedades, contratos, pagos y mantenimientos desde una sola plataforma. Sin papeleo, sin intermediarios innecesarios.',
    },
    {
      icon: <ForumIcon sx={{ fontSize: 40, color: 'primary.main' }} />,
      title: 'Comunicación Directa',
      description:
        'Mensajería en tiempo real entre arrendadores, arrendatarios y proveedores de servicios. Notificaciones instantáneas y seguimiento de conversaciones.',
    },
    {
      icon: <VisibilityIcon sx={{ fontSize: 40, color: 'primary.main' }} />,
      title: 'Transparencia Total',
      description:
        'Sistema de calificaciones verificadas, historial de transacciones y documentos auditables. Cada interacción queda registrada de forma segura.',
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        'Crea tu cuenta con verificación de identidad colombiana. Tu información está protegida con estándares bancarios.',
    },
    {
      icon: <SearchIcon sx={{ fontSize: 32, color: 'white' }} />,
      title: 'Explora propiedades o publica las tuyas',
      description:
        'Busca propiedades con filtros avanzados o publica las tuyas con fotos, videos y ubicación en mapa.',
    },
    {
      icon: <FingerprintIcon sx={{ fontSize: 32, color: 'white' }} />,
      title: 'Firma contratos con autenticación biométrica',
      description:
        'Contratos digitales con validez legal. Autenticación facial, dactilar y de voz para máxima seguridad.',
    },
  ];
        ...
        >
          ...
          >
            ...
            <Fade in timeout={800} style={{ transitionDelay: '400ms' }}>
              ...
              >
                Conectamos arrendadores, arrendatarios y prestadores de
                servicios en una plataforma integral, segura y con contratos
                biométricos legalmente válidos.
              </Typography>
            </Fade>
        ...
        <Container maxWidth='md'>
          <ScrollRevealBox>
            <Box sx={{ textAlign: 'center' }}>
              ...
              >
                Únete a la plataforma que está revolucionando el sector
                inmobiliario en Colombia con tecnología de punta y seguridad
                biométrica.
              </Typography>
              <Box
                sx={{
