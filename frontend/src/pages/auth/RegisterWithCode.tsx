...
export const RegisterWithCode: React.FC = () => {
  ...
  const validateInterviewCode = async (code: string) => {
    ...
    try {
      ...
      const response = await fetch(
        '/api/v1/users/auth/validate-interview-code/',
        {
          method: 'POST',
          headers: {
      ...
      if (response.ok && data.is_valid) {
        ...
        if (response.status === 404) {
          ...
          errorMessage =
            ' El código aún no ha sido aprobado por el administrador';
  ...
  const handleInterviewCodeChange = (
  ...
  const getCodeValidationIcon = () => {
    ...
    if (codeValidation.message && !codeValidation.isValid)
      ...
      <Card sx={{ maxWidth: 800, width: '100%', mx: 2 }}>
        <CardContent sx={{ p: 4 }}>
          ...
          <Typography
            ...
            sx={{ mb: 4 }}
          >
            Completa tu registro usando el código único recibido después de tu
            entrevista.
            <br />
            <strong>
              Proporcionamos un registro completo para garantizar la seguridad y
              confianza entre todos los miembros de nuestra comunidad.
            </strong>
          </Typography>
          ...
          <Card
            sx={{
              mb: 3,
              border: codeValidation.isValid
                ? `2px solid ${vhColors.success}`
          ...
          >
            <CardContent sx={{ pb: 2 }}>
              ...
              <TextField
                ...
                error={Boolean(
                  codeValidation.message && !codeValidation.isValid,
                )}
                helperText={
                    ...
                    <InputAdornment position='end'>
                        ...
                        title={
                          codeValidating
                            ...
                            : codeValidation.isValid
                              ? 'Código válido y verificado'
                              : interviewCode.length >= 8
                                ? 'Haga clic para validar el código'
                      ...
                      >
                        <IconButton
                          ...
                          size='small'
                          sx={{
                            color: codeValidation.isValid
                              ? 'success.main'
                              : interviewCode.length >= 8
                                ? 'primary.main'
                                : 'action.disabled',
                            '&:hover': {
                              backgroundColor: codeValidation.isValid
                                ? 'success.light'
                                : 'primary.light',
                            },
                          }}
                ...
                <Alert severity='success' sx={{ mb: 2 }}>
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    <Typography variant='body2' gutterBottom>
                      ...
                      {getUserTypeLabel(
                        codeValidation.codeData.user_type ?? '',
                      )}
                    </Typography>
                  ...
                  >
                    ...
                    >
                      Este código fue generado automáticamente por el panel de
                      administración de Django y está asociado al correo
                ...
                interviewCode.length >= 8 && (
                  <Alert severity='error' sx={{ mb: 2 }}>
                    ...
                    >
                      <Typography
                        variant='body2'
                        sx={{ color: 'error.dark', fontWeight: 'bold', mb: 1 }}
                      >
              ...
              {interviewCode.length > 0 && interviewCode.length < 8 && (
                <Alert severity='info' sx={{ mb: 2 }}>
                  ...
                  <Typography variant='caption'>
                    El código debe tener al menos 8 caracteres para poder
                    validarlo.
                  </Typography>
                </Alert>
              )}
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      required
                      error={
                        password2 !== '' && password2 !== formData.password
                      }
                      helperText={
                        password2 !== '' && password2 !== formData.password
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        >
                          <MenuItem value='low'>
                            Económico (Hasta $1,500,000)
                          </MenuItem>
                          <MenuItem value='medium'>
                            Medio ($1,500,000 - $3,000,000)
                          </MenuItem>
                          <MenuItem value='high'>
                            Alto ($3,000,000 - $5,000,000)
                          </MenuItem>
                          <MenuItem value='luxury'>
                            Premium (Más de $5,000,000)
                          </MenuItem>
                        </Select>
                      </FormControl>
                    </Grid>
                      ...
                      <FormControl fullWidth>
                        ...
                        >
                          <MenuItem value='first_time'>
                            Primera vez viviendo solo/a
                          </MenuItem>
                          <MenuItem value='work_relocation'>
                            Cambio de trabajo
                          </MenuItem>
                          <MenuItem value='family_growth'>
                            Crecimiento familiar
                          </MenuItem>
                          <MenuItem value='better_location'>
                            Mejor ubicación
                          </MenuItem>
                    ...
                    <Grid item xs={12}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          input={
                            <OutlinedInput label='Tipos de Propiedades que Maneja' />
                          }
                        ...
                        >
                          ...
                          <MenuItem value='Local Comercial'>
                            Local Comercial
                          </MenuItem>
                        ...
                        <FormHelperText>
                          Seleccione todos los tipos de propiedades que
                          administra
                        </FormHelperText>
                      </FormControl>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        >
                          ...
                          <MenuItem value='small_company'>
                            Pequeña Empresa (2-10 empleados)
                          </MenuItem>
                          <MenuItem value='company'>
                            Empresa Establecida (10+ empleados)
                          </MenuItem>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        >
                          ...
                          <MenuItem value='extended_hours'>
                            Horario Extendido (7am-8pm)
                          </MenuItem>
                          <MenuItem value='emergency'>
                            Disponible 24/7 (Emergencias)
                          </MenuItem>
                    ...
                    <Grid item xs={12}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          input={
                            <OutlinedInput label='Especialidades Adicionales' />
                          }
                          renderValue={selected => (
                            <Box
                              sx={{
                        ...
                        >
                          <MenuItem value='emergency_service'>
                            Servicio de Emergencia
                          </MenuItem>
                          <MenuItem value='warranty_service'>
                            Servicio con Garantía
                          </MenuItem>
                          <MenuItem value='eco_friendly'>
                            Servicios Ecológicos
                          </MenuItem>
                          <MenuItem value='certified_technician'>
                            Técnico Certificado
                          </MenuItem>
                          <MenuItem value='multilingual'>
                            Atención Multiidioma
                          </MenuItem>
                          <MenuItem value='online_quote'>
                            Cotización en Línea
                          </MenuItem>
                        </Select>
                        <FormHelperText>
                          Seleccione las especialidades que mejor describan su
                          servicio
                        </FormHelperText>
                      </FormControl>
                    </Grid>
          ...
          {!interviewCode && (
            <Alert severity='info' sx={{ mt: 3 }}>
              <Typography variant='body2'>
                <strong>¿No tienes un código de entrevista?</strong>
                <br />
                Primero debes contactarnos y completar una entrevista. El código
                será enviado por correo electrónico si eres aprobado.
              </Typography>
            </Alert>
          )}
        </CardContent>
