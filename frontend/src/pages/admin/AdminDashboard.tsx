...
const AdminDashboard: React.FC = () => {
  ...
  const { isAdmin, adminPermissions } = useAdminAuth();
  ...
  const { data: pendingContracts = [], isLoading: contractsLoading } = useQuery(
    {
  ...
  const contractsArray = Array.isArray(pendingContracts)
    ? pendingContracts
    : [];
      ...
      {stats?.urgent_contracts && stats.urgent_contracts > 0 && (
        ...
        >
          <Typography fontWeight='medium'>
            {stats.urgent_contracts} contrato(s) llevan más de 7 días pendientes
            de revisión
          </Typography>
        </Alert>
      )}
                      ...
                      <ListItemText
                        ...
                        secondary={
                          ...
                          >
                            ...
                            >
                              {contract.landlord_name || 'Sin arrendador'}{' '}
