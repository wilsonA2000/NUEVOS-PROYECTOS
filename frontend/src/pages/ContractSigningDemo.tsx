      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant='subtitle1' color='text.secondary'>
            Demostración del sistema de firma digital avanzada conectado al
            backend
          </Typography>
        </Box>
        ...
        <Alert severity='info' sx={{ mb: 4 }}>
          ...
          <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
            ...
            <li>
              Verificación biométrica simulada (placeholder para APIs reales)
            </li>
          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardContent>
                ...
                <Typography variant='body2' sx={{ mb: 2 }}>
                  <strong>Rol:</strong>{' '}
                  {mockContract.signerRole === 'tenant'
                    ? 'Arrendatario'
                    : 'Arrendador'}
                </Typography>
        ...
        {signatureComplete && signatureData && (
          <Alert severity='success' sx={{ mt: 3 }}>
            ...
            <Typography variant='body2'>
              ...
              {signatureData.verificationLevel}
            </Typography>
            <Typography variant='body2'>
              <strong>Timestamp:</strong>{' '}
              {signatureData.timestamp.toLocaleString()}
            </Typography>
            <Typography variant='body2'>
              <strong>ID de firma:</strong>{' '}
              {signatureData.signatureData?.id || 'generado-en-backend'}
            </Typography>
          </Alert>
        )}
        ...
        <Alert severity='warning' sx={{ mt: 3 }}>
          <Typography variant='body2'>
            <strong>Nota de Desarrollo:</strong> Este sistema está completamente
            conectado al backend Django real. La verificación biométrica utiliza
            simulación segura como placeholder para integración futura con APIs
            reales de reconocimiento facial y OCR.
          </Typography>
        </Alert>
      </Paper>
