    ...
    <>
      ...
      <Grid container spacing={3} sx={{ mb: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          {getStatCard(
            ...
            stats?.contracts?.expiringSoon
              ? `${stats.contracts.expiringSoon} días`
              : '-- días',
            0,
            <CalendarTodayIcon />,
      ...
      <Paper sx={{ p: 3, mb: 3, textAlign: 'center' }}>
        ...
        <Typography variant='body2' color='textSecondary'>
          Aquí puedes ver tus propiedades arrendadas, contratos activos y
          gestionar tus pagos de arriendo.
        </Typography>
      </Paper>
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Typography variant='body2' color='textSecondary'>
          No tienes solicitudes recientes. Explora propiedades disponibles para
          enviar solicitudes de interés.
        </Typography>
      </Paper>
    </>
  );
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await api.get(
        `/dashboard/stats/?period=${selectedPeriod}`,
      );
    ...
    datasets: [
      {
        ...
        data:
          stats && stats.ratings && stats.ratings.distribution
            ? [
            ...
            <Button
              ...
              onClick={async () => {
                try {
                  ...
                  link.setAttribute(
                    'download',
                    `dashboard-export-${selectedPeriod}.csv`,
                  );
                  ...
                  showError(
                    'No se pudo exportar el dashboard. Intenta de nuevo más tarde.',
                  );
                }
              }}
            >
