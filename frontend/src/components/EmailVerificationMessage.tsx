...
export const EmailVerificationMessage: React.FC<
  EmailVerificationMessageProps
> = ({ email, onResendEmail, isResending = false }) => {
  return (
    <Card
      sx={{
        maxWidth: 600,
        ...
        <Stack spacing={3} alignItems='center' textAlign='center'>
          ...
          <Box sx={{ width: '100%' }}>
            ...
            <Stack spacing={2}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                />
                <Typography>
                  <strong>Haz click en el enlace</strong> de verificación en el
                  email
                </Typography>
              </Box>
          ...
          <Alert severity='info' sx={{ width: '100%' }}>
            ...
            <Typography variant='body2'>
              Si el enlace expira, podrás solicitar un nuevo email de
              verificación.
            </Typography>
          </Alert>
          ...
          <Alert severity='warning' sx={{ width: '100%' }}>
            <Typography variant='body2'>
              ...
              <br />
              Algunos proveedores de email pueden clasificar nuestros mensajes
              como spam. Revisa tu carpeta de spam/promociones y marca nuestro
              email como "No es spam".
            </Typography>
          </Alert>
        </Stack>
      </CardContent>
