        ...
        <DialogContentText component='div'>
          <Stack spacing={1.5}>
            <Typography variant='body2'>
              Estás por certificar como abogado titulado el acta de verificación
            ...
            <Alert severity='info'>
              ...
              la Ley 527 de 1999 (mensajes de datos) con tu credencial admin y
              tu T.P. configurada en backend.
            </Alert>
