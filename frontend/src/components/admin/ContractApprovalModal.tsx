    ...
    <Dialog open={open} onClose={handleClose} maxWidth='sm' fullWidth>
      ...
      <DialogContent>
        ...
        >
          ...
          <Box>
            ...
            <Typography variant='caption' color='text.secondary'>
              Al aprobar este contrato, confirmo que he revisado las cláusulas y
              que cumplen con la Ley 820 de 2003 de arrendamiento de vivienda
              urbana en Colombia.
            </Typography>
          </Box>
        </Box>
      ...
      <DialogActions sx={{ px: 3, pb: 3 }}>
        ...
        <Button
          ...
          disabled={isLoading}
          startIcon={
            isLoading ? <CircularProgress size={20} /> : <ApproveIcon />
          }
        >
          {isLoading
            ? 'Aprobando...'
