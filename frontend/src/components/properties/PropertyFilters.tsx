...
const PROPERTY_TYPES = [
  ...
  { value: 'townhouse', label: 'Casa Conjunto', icon: '' },
...
const FEATURE_CHIPS = [
  { key: 'has_parking', label: 'Parqueadero', icon: '' },
  { key: 'has_pool', label: 'Piscina', icon: '' },
  { key: 'allows_pets', label: 'Mascotas', icon: '' },
  { key: 'is_furnished', label: 'Amoblada', icon: '' },
];
        ...
        <Stack direction='row' spacing={1} justifyContent='flex-end'>
          <Tooltip title='Filtros Avanzados'>
            <IconButton
              ...
              color={
                showAdvanced || advancedFiltersCount > 0 ? 'primary' : 'default'
              }
              size='small'
              sx={{
                border: '1px solid',
            ...
            >
              <Badge
                badgeContent={advancedFiltersCount || undefined}
                color='primary'
              >
                <TuneIcon />
              </Badge>
      ...
      <Stack direction='row' spacing={1} flexWrap='wrap' useFlexGap>
        {FEATURE_CHIPS.map(feature => (
          <Chip
            ...
            variant={
              filters[feature.key as keyof PropertySearchFilters]
                ? 'filled'
                : 'outlined'
            }
            color={
        ...
        {featuresCount > 0 && (
          ...
          >
            {featuresCount} filtro{featuresCount !== 1 ? 's' : ''} activo
            {featuresCount !== 1 ? 's' : ''}
          </Typography>
        )}
      </Stack>
  ...
  return (
    <>
      ...
      >
        ...
        {!isMobile && (
          <Collapse in={showAdvanced}>{renderAdvancedFilters()}</Collapse>
        )}
