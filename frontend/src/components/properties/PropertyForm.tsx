...
const PropertyForm: React.FC<PropertyFormProps> = ({ 
 ...
 ...s,
 place_name: `${s.place_name} ${s.properties?.provider === 'nominatim' ? '' : s.properties?.provider === 'mapbox' ? '' : ''}`.trim(),
 }));
 ...
 setSuccessMessage(' Por favor selecciona una ubicación en el mapa primero');
