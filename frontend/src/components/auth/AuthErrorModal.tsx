...
const AuthErrorModal: React.FC<AuthErrorModalProps> = ({
  ...
  const isVerificationError =
    error.includes('autorizada') || error.includes('verificada');
    ...
    >
      <DialogTitle
        sx={{
          ...
          backgroundColor: isVerificationError
            ? vhColors.warningBg
            : vhColors.errorBg,
        }}
      >
      ...
      <DialogContent sx={{ pt: 2 }}>
        ...
        {isVerificationError && (
          ...
          >
            <Typography
              variant='h6'
              sx={{ mb: 2, fontWeight: 600, color: vhColors.textPrimary }}
            >
            ...
            <Box sx={{ mb: 3 }}>
              <Typography
                variant='body2'
                sx={{ mb: 2, color: vhColors.textSecondary }}
              >
            ...
            >
              <Typography
                variant='subtitle2'
                sx={{ mb: 1, fontWeight: 600, color: vhColors.accentBlue }}
              >
                Contacto Directo:
              </Typography>
