    ...
    >
      ...
      >
        <Box sx={{ mb: 3 }}>
          <Alert severity='info' sx={{ mb: 2 }}>
            <Typography variant='body2'>
              <strong>Importante:</strong> Por favor lee completamente estos
              términos y condiciones antes de aceptarlos.
            </Typography>
          </Alert>
        ...
        <Typography variant='body2' paragraph>
          Al acceder y utilizar la plataforma VeriHome, usted acepta estar
          legalmente obligado por estos Términos y Condiciones. Si no está de
          acuerdo con alguno de estos términos, no debe utilizar nuestros
          servicios.
        </Typography>
        <Typography variant='body2' paragraph>
        ...
        <Typography variant='body2' paragraph>
          VeriHome es una plataforma inmobiliaria que conecta arrendadores,
          arrendatarios y prestadores de servicios. Facilitamos la publicación
          de propiedades, la búsqueda de viviendas y la contratación de
          servicios relacionados con bienes raíces.
        </Typography>
        <Typography variant='body2' paragraph>
        ...
        <Typography variant='body2' paragraph>
          Para utilizar ciertos servicios de VeriHome, es necesario crear una
        ...
        <Box component='ul' sx={{ pl: 3, mb: 2 }}>
          ...
          <Typography component='li' variant='body2' paragraph>
            Notificar inmediatamente a VeriHome sobre cualquier uso no
        ...
        <Typography variant='body2' paragraph>
          Los arrendadores son responsables de proporcionar información precisa
          y actualizada sobre sus propiedades. VeriHome no garantiza la
          exactitud de la información publicada por los usuarios.
        </Typography>
        <Typography variant='body2' paragraph>
        ...
        <Typography variant='body2' paragraph>
          VeriHome facilita la generación de contratos de arrendamiento
          digitales. Sin embargo, la responsabilidad legal del cumplimiento de
          los términos del contrato recae en las partes involucradas.
        </Typography>
        <Typography variant='body2' paragraph>
          Los pagos se procesan a través de proveedores de servicios de pago de
          terceros. VeriHome no almacena información de tarjetas de crédito y no
          es responsable de las transacciones realizadas por estos proveedores.
        </Typography>
        ...
        <Typography variant='body2' paragraph>
          Los usuarios pueden calificar y reseñar propiedades, arrendadores,
          arrendatarios y prestadores de servicios. Las calificaciones deben ser
          honestas y basadas en experiencias reales.
        </Typography>
        <Typography variant='body2' paragraph>
          VeriHome se reserva el derecho de eliminar calificaciones falsas,
          difamatorias o que violen nuestras políticas.
        </Typography>
        ...
        <Typography variant='body2' paragraph>
          VeriHome se reserva el derecho de modificar estos términos en
          cualquier momento. Los cambios entrarán en vigor inmediatamente
          después de su publicación en la plataforma.
        </Typography>
        <Typography variant='body2' paragraph>
          Es su responsabilidad revisar periódicamente estos términos para estar
