    ...
    >
      ...
      >
        <Box sx={{ mb: 3 }}>
          <Alert severity='info' sx={{ mb: 2 }}>
            <Typography variant='body2'>
              <strong>Importante:</strong> Esta política de privacidad está
              ajustada a la Ley 1581 de 2012 de Colombia. Por favor lee
              completamente antes de aceptar.
            </Typography>
          </Alert>
        ...
        <Typography variant='body2' paragraph>
          En <strong>VeriHome</strong>, recopilamos información personal como
          nombre, dirección de correo electrónico, número de teléfono y, en
          algunos casos, información de identificación oficial para verificar su
          identidad.
        </Typography>
        <Typography variant='body2' paragraph>
        ...
        <Box component='ul' sx={{ pl: 3, mb: 2 }}>
          ...
          <Typography component='li' variant='body2' paragraph>
            <strong>Información de verificación:</strong> copia de
            identificación oficial, comprobantes de domicilio, información
            fiscal.
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Información de pago:</strong> datos de tarjetas de
            crédito/débito, información bancaria para transferencias.
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Información de propiedades:</strong> ubicación,
            características, imágenes, documentos legales.
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Información de uso:</strong> cómo interactúa con nuestra
            plataforma, preferencias, historial de búsqueda.
          </Typography>
        </Box>
        ...
        <Box component='ul' sx={{ pl: 3, mb: 2 }}>
          <Typography component='li' variant='body2' paragraph>
            Facilitar la conexión entre arrendadores, arrendatarios y
          ...
          <Typography component='li' variant='body2' paragraph>
            Verificar la identidad de los usuarios para garantizar la seguridad
            de la plataforma
          </Typography>
          <Typography component='li' variant='body2' paragraph>
        ...
        <Typography variant='body2' paragraph>
          El tratamiento de sus datos personales se basa en las siguientes bases
          legales:
        </Typography>
        <Box component='ul' sx={{ pl: 3, mb: 2 }}>
          <Typography component='li' variant='body2' paragraph>
            <strong>Consentimiento:</strong> Su consentimiento libre, previo,
            expreso, informado e inequívoco
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Ejecución de contrato:</strong> Para la prestación de
            nuestros servicios
          </Typography>
          <Typography component='li' variant='body2' paragraph>
          ...
          <Typography component='li' variant='body2' paragraph>
            <strong>Cumplimiento legal:</strong> Para cumplir con obligaciones
        ...
        <Typography variant='body2' paragraph>
          De conformidad con la Ley 1581 de 2012, usted tiene los siguientes
          derechos:
        </Typography>
        <Box component='ul' sx={{ pl: 3, mb: 2 }}>
          <Typography component='li' variant='body2' paragraph>
            <strong>Conocer, actualizar y rectificar:</strong> Sus datos
            personales frente a VeriHome
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Revocar:</strong> La autorización y/o solicitar la supresión
            de datos
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Acceso libre:</strong> A sus datos personales que hayan sido
            objeto de tratamiento
          </Typography>
          <Typography component='li' variant='body2' paragraph>
            <strong>Ser informado:</strong> Sobre el uso que se ha dado a sus
            datos personales
          </Typography>
          <Typography component='li' variant='body2' paragraph>
        ...
        <Typography variant='body2' paragraph>
          VeriHome implementa medidas técnicas, humanas y administrativas para
        ...
        <Typography variant='body2' paragraph>
          Todas las transferencias se realizan con las garantías de seguridad
          apropiadas y en cumplimiento de la normativa aplicable.
        </Typography>
        ...
        <Typography variant='body2' paragraph>
          Sus datos personales serán conservados durante el tiempo necesario
          para cumplir con las finalidades para las cuales fueron recopilados,
          incluyendo obligaciones legales, contractuales y regulatorias.
        </Typography>
        <Typography variant='body2' paragraph>
          Una vez cumplidas las finalidades, los datos serán eliminados de forma
          segura, salvo cuando deban conservarse por obligaciones legales.
        </Typography>
        ...
        <Typography variant='body2' paragraph>
          ...
          en nuestra plataforma. Estas tecnologías nos permiten:
        </Typography>
        <Box component='ul' sx={{ pl: 3, mb: 2 }}>
          <Typography component='li' variant='body2' paragraph>
        ...
        <Typography variant='body2' paragraph>
          ...
          afectar la funcionalidad de nuestra plataforma.
        </Typography>
        ...
        <Typography variant='body2' paragraph>
          ...
          Si usted es menor de edad, no debe proporcionar información personal
        ...
        <Typography variant='body2' paragraph>
          Le notificaremos sobre cambios significativos a través de nuestra
        ...
        <Typography variant='body2' paragraph>
          Para ejercer sus derechos como titular de datos personales o realizar
          consultas sobre esta política, puede contactarnos a través de:
        </Typography>
        <Box sx={{ pl: 2, mb: 2 }}>
          <Typography variant='body2' paragraph>
          ...
          <Typography variant='body2' paragraph>
            <strong>Horario de atención:</strong> Lunes a Viernes de 8:00 AM a
            6:00 PM
          </Typography>
        </Box>
        <Typography variant='body2' paragraph>
          También puede presentar quejas ante la Superintendencia de Industria y
          Comercio (SIC) a través de su página web: www.sic.gov.co
        </Typography>
