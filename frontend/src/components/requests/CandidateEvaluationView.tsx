...
const CandidateEvaluationView: React.FC<CandidateEvaluationViewProps> = ({
  ...
  const getScoreColor = (score: number) => {
    ...
    if (score >= 40)
      return (theme.palette as any).orange?.main || vhColors.warning;
  ...
  const MetricCard: React.FC<{
    ...
    return (
      <Card
        sx={{ height: '100%', border: `2px solid ${getStatusColor(status)}20` }}
      >
        <CardContent sx={{ textAlign: 'center', py: 2 }}>
          ...
          >
            ...
            <Typography
              variant='h6'
              sx={{ ml: 1, color: getStatusColor(status) }}
            >
              {value}
            </Typography>
          </Box>
  ...
  const FlagAlert: React.FC<{ flags: Flag[]; type: 'red' | 'green' }> = ({
    flags,
    type,
  }) => {
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', p: 3 }}>
            ...
            <Grid item xs>
              ...
              <Stack direction='row' spacing={1} flexWrap='wrap'>
                ...
                <Chip
                  ...
                  label={
                    data.basic_info.is_verified ? 'Verificado' : 'Sin verificar'
                  }
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant='body1'>
                        {data.match_request_info.tenant_phone ||
                          data.basic_info.phone ||
                          'No especificado'}
                      </Typography>
                    </Box>
                ...
                <Grid item xs={12} sm={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant='body1'>
                        {data.match_request_info.tenant_email ||
            ...
            <CardContent>
                ...
                <Grid item xs={12} sm={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant='body1'>
                        {data.match_request_info.employment_type ===
                          'employed' && 'Empleado'}
                        {data.match_request_info.employment_type ===
                        ...
                        {data.match_request_info.employment_type === 'other' &&
                          'Otro'}
                        {!data.match_request_info.employment_type &&
                          'No especificado'}
                      </Typography>
              ...
              <Box sx={{ mt: 3 }}>
                ...
                <Stack direction='row' spacing={1} flexWrap='wrap'>
                  <Chip
                    icon={
                      data.match_request_info.has_employment_proof ? (
                        <CheckCircleIcon />
                      ) : (
                        <WarningIcon />
                      )
                  ...
                  <Chip
                    icon={
                      data.match_request_info.has_rental_references ? (
                        <CheckCircleIcon />
                      ) : (
                        <WarningIcon />
                      )
                  ...
                  <Chip
                    icon={
                      data.match_request_info.has_credit_check ? (
                        <CheckCircleIcon />
                      ) : (
                        <WarningIcon />
                      )
            ...
            <CardContent>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <CalendarIcon
                      sx={{ color: theme.palette.info.main, mr: 2 }}
                    />
                    <Box>
                      <Typography variant='body2' color='text.secondary'>
                ...
                <Grid item xs={12} sm={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant='body1'>
                        {data.match_request_info.number_of_occupants || 1}{' '}
                        persona(s)
                      </Typography>
                    </Box>
                  </Box>
                ...
                <Grid item xs={12} sm={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Chip
                        label={
                          data.match_request_info.priority === 'low'
                            ? 'Baja'
                            : data.match_request_info.priority === 'medium'
                              ? 'Media'
                              : data.match_request_info.priority === 'high'
                                ? 'Alta'
                                : data.match_request_info.priority === 'urgent'
                                  ? 'Urgente'
                                  : 'Media'
                        }
                        color={
                ...
                <Grid item xs={12} sm={6}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Chip
                        label={
                          data.match_request_info.smoking_allowed
                            ? 'Sí fuma'
                            : 'No fuma'
                        }
                        color={
      ...
      {data.match_request_info && (
        <Card
          sx={{ mb: 3, border: `2px solid ${theme.palette.warning.main}20` }}
        >
          <CardContent>
            <Box
              sx={{
        ...
        <CardContent>
          {data.match_request_info ? (
            <>
              {data.match_request_info.status === 'pending' && (
                <>
                  <Alert severity='warning' sx={{ mb: 3 }}>
                    ...
                    Revisa la información del candidato y decide si aprobar el
                    match. Si lo apruebas, aparecerá en tu módulo de contratos
              ...
              {data.match_request_info.status === 'accepted' && (
                ...
                >
                  ...
                  Este candidato ya fue aprobado. Ahora está disponible en tu
                  módulo de contratos para continuar el proceso.
                </Alert>
              )}
              ...
              {data.match_request_info.status === 'rejected' && (
                ...
                >
                  ...
                  Has rechazado a este candidato. No aparecerá en tu módulo de
                  contratos.
                </Alert>
              )}
            </>
            ...
            <Alert severity='info' sx={{ mb: 2 }}>
              ...
              Esta es una vista informativa. Las solicitudes específicas se
              manejan a través del sistema de matches.
            </Alert>
          )}
