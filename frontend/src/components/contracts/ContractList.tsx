...
export const ContractList: React.FC = () => {
  ...
  const handleSendForReview = async (contractId: string) => {
    try {
      ...
      showError(
        'Error al enviar el contrato para revisión. Por favor, intenta de nuevo.',
      );
    }
  };
              ...
              <CardContent sx={{ flexGrow: 1 }}>
                ...
                {contract.property ? (
                  <Box sx={{ mt: 1, mb: 2 }}>
                    ...
                    <Box display='flex' gap={1} flexWrap='wrap' mt={1}>
                      <Chip
                        size='small'
                        label={contract.property.address || 'Sin dirección'}
                      />
                    </Box>
                  </Box>
                ) : (
                ...
                {contract.secondary_party ? (
                  ...
                  >
                    ...
                    <Typography variant='body2'>
                      {contract.secondary_party.first_name &&
                      contract.secondary_party.last_name
                ...
                <Box sx={{ mb: 2 }}>
                  <Typography variant='body2'>
                    ...
                    {contract.start_date || 'No especificada'}
                  </Typography>
                  <Typography variant='body2'>
                    <strong>Renta:</strong> $
