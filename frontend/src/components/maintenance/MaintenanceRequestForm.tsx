...
const MAINTENANCE_TYPES = [
  {
    ...
    description: 'Problemas urgentes que requieren atenci\u00f3n inmediata',
  },
  {
    value: 'routine',
    label: 'Rutinario',
  ...
  },
  {
    ...
    description: 'Prevenci\u00f3n de problemas futuros',
  },
  {
    value: 'repair',
    label: 'Reparaci\u00f3n',
    ...
    description: 'Reparaci\u00f3n de da\u00f1os existentes',
  },
  {
    value: 'improvement',
    label: 'Mejora',
    ...
    description: 'Mejoras o actualizaciones del inmueble',
  },
];
...
const MaintenanceRequestForm: React.FC<MaintenanceRequestFormProps> = ({
  ...
  const selectedType = MAINTENANCE_TYPES.find(
    t => t.value === formData.maintenance_type,
  );
      ...
      <DialogContent sx={{ p: { xs: 2, md: 3 }, mt: 1 }}>
        {success && (
          <Alert severity='success' sx={{ mb: 3 }}>
            Solicitud creada exitosamente. Ser\u00e1s notificado cuando sea
            atendida.
          </Alert>
        )}
        ...
        <Grid container spacing={3}>
              ...
              {MAINTENANCE_TYPES.map(type => (
                <Grid item xs={6} sm={4} md={2.4} key={type.value}>
                  <Paper
                    ...
                    onClick={() =>
                      !submitting &&
                      handleChange('maintenance_type', type.value)
                    }
                    sx={{
                      p: 1.5,
                      textAlign: 'center',
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={e =>
                handleChange('access_instructions', e.target.value)
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={e =>
                handleChange('estimated_duration_hours', e.target.value)
              }
              placeholder='Ej: 2'
              disabled={submitting}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={e =>
                      handleChange('requires_tenant_presence', e.target.checked)
                    }
                    disabled={submitting}
                    color='primary'
                  />
