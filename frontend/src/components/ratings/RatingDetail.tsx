...
export const RatingDetail: React.FC = () => {
  ...
  if (error) {
    return (
      <Typography color='error'>Error al cargar la calificación</Typography>
    );
  }
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', p: 3 }}>
      ...
      >
        ...
        <Button variant='outlined' onClick={() => navigate('/app/ratings')}>
          Volver
        </Button>
      </Box>
      ...
      <Card>
        <CardContent>
          ...
          <Box mb={3}>
            ...
            <Rating value={rating.overall_rating || 0} readOnly size='large' />
