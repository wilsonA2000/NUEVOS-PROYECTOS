...
const ContractsDashboard = lazy(
  () => import('../components/contracts/ContractsDashboard'),
);
const LandlordContractsDashboard = lazy(
  () => import('../components/contracts/LandlordContractsDashboard'),
);
const TenantContractsDashboard = lazy(
  () => import('../components/contracts/TenantContractsDashboard'),
);
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path='*'
          element={<Navigate to='/contracts/dashboard' replace />}
        />
      </Routes>
    </React.Suspense>
  );
  ...
  return (
    <React.Suspense fallback={<LoadingSpinner message='Cargando...' />}>
      <Routes>
        ...
        <Route
          path='*'
          element={<Navigate to='/contracts/landlord/dashboard' replace />}
        />
      </Routes>
    </React.Suspense>
  );
  ...
  return (
    <React.Suspense fallback={<LoadingSpinner message='Cargando...' />}>
      <Routes>
        ...
        <Route
          path='*'
          element={<Navigate to='/contracts/tenant/dashboard' replace />}
        />
      </Routes>
    </React.Suspense>
  );
