...
class PayPalService {
  ...
  initialize(config: PayPalConfig): void {
    ...
    loggingService.log(
      LogLevel.INFO,
      LogCategory.SYSTEM,
      'PayPal initialized successfully',
    );
  }
  ...
  async createSubscriptionPlan(planData: {
    ...
    try {
      ...
      loggingService.log(
        LogLevel.INFO,
        LogCategory.API,
        'PayPal subscription plan created',
      ...
      loggingService.log(
        LogLevel.ERROR,
        LogCategory.API,
        'Error creating PayPal subscription plan',
        { error },
      );
      throw error;
    }
  ...
  async getTransactionHistory(
    ...
    try {
      ...
      loggingService.log(
        LogLevel.ERROR,
        LogCategory.API,
        'Error getting PayPal transaction history',
        { error },
      );
      throw error;
    }
  ...
  async getPayoutDetails(payoutBatchId: string): Promise<any> {
    try {
      ...
      loggingService.log(
        LogLevel.ERROR,
        LogCategory.API,
        'Error getting PayPal payout details',
        { error },
      );
      throw error;
    }
  ...
  async cancelPayoutItem(payoutItemId: string): Promise<any> {
    try {
      const response = await api.post(
        `/payments/paypal/payout-items/${payoutItemId}/cancel/`,
      );
      loggingService.log(
        LogLevel.INFO,
        LogCategory.API,
        'PayPal payout item cancelled',
        { payoutItemId },
      );
      return response.data;
    } catch (error) {
      loggingService.log(
        LogLevel.ERROR,
        LogCategory.API,
        'Error cancelling PayPal payout item',
        { error },
      );
      throw error;
    }
