...
SPECTACULAR_SETTINGS = {
    ...
    "TAGS": [
        ...
        {
            "name": "Contracts",
            "description": "Contract management with biometric authentication",
        },
...
DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL", default="VeriHome Platform <verihomeadmi@gmail.com>"
)
SERVER_EMAIL = config(
    "SERVER_EMAIL", default="VeriHome Platform <verihomeadmi@gmail.com>"
)
...
try:
    ...
    import redis
    import channels_redis  # noqa: F401  probe de disponibilidad
    ...
    if DEBUG:
        try:
            ...
            print(
                "WARNING: Redis no disponible para WebSocket - Usando InMemoryChannelLayer"
            )
    else:
