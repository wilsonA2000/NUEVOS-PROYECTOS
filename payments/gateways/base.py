...
class BasePaymentGateway(ABC):
    ...
    def handle_error(
        self, error: Exception, extra: Dict[str, Any] = None
    ) -> "PaymentResult":
    ...
    def log_error(self, message: str, extra: Dict[str, Any] = None):
        ...
        logger.error(f"[{self.__class__.__name__}] {message}", extra=extra or {})

    def log_info(self, message: str, extra: Dict[str, Any] = None):
        """Log an info message."""
        logger.info(f"[{self.__class__.__name__}] {message}", extra=extra or {})
