...
class PSECreatePaymentTests(TestCase):
    ...
    def test_create_payment_success(self, mock_post):
        ...
        result = gateway.create_payment(
            amount=Decimal('200000'), currency='COP',
            customer_email='tt@test.com', customer_name='Tenant',
            description='Servicio limpieza', reference='REF-PSE-001',
            customer_id='1234567890', customer_phone='3001234567',
        )
    ...
    def test_create_payment_rejects_non_cop(self):
        ...
        result = gateway.create_payment(
            ...
            customer_email='x@x.com', customer_name='X', description='X',
            reference='R-1',
        )
    ...
    def test_create_payment_handles_network_error(self, mock_post):
        ...
        gateway = _make_gateway()
        result = gateway.create_payment(
            amount=Decimal('100000'), currency='COP',
            customer_email='x@x.com', customer_name='X', description='X',
            reference='R-2',
        )
        self.assertFalse(result.success)
