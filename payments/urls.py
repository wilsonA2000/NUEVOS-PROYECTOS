...
urlpatterns = [
    ...
    path(
        "transaccion/<uuid:pk>/recibo/",
        views.TransactionReceiptView.as_view(),
        name="transaction_receipt",
    ),
    path(
        "transaccion/<uuid:pk>/reembolsar/",
        views.RefundTransactionView.as_view(),
        name="refund_transaction",
    ),
    path(
        "transaccion/<uuid:pk>/disputar/",
        views.DisputeTransactionView.as_view(),
        name="dispute_transaction",
    ),
    # Métodos de pago
    path(
        "metodos-pago/", views.PaymentMethodListView.as_view(), name="payment_methods"
    ),
    path(
        "metodos-pago/agregar/",
        views.AddPaymentMethodView.as_view(),
        name="add_payment_method",
    ),
    path(
        "metodos-pago/<int:pk>/editar/",
        views.EditPaymentMethodView.as_view(),
        name="edit_payment_method",
    ),
    path(
        "metodos-pago/<int:pk>/eliminar/",
        views.DeletePaymentMethodView.as_view(),
        name="delete_payment_method",
    ),
    path(
        "metodos-pago/<int:pk>/verificar/",
        views.VerifyPaymentMethodView.as_view(),
        name="verify_payment_method",
    ),
    path(
        "metodos-pago/<int:pk>/predeterminado/",
    ...
    path(
        "pagar/renta/<uuid:contract_pk>/", views.PayRentView.as_view(), name="pay_rent"
    ),
    path(
        "pagar/deposito/<uuid:contract_pk>/",
        views.PayDepositView.as_view(),
        name="pay_deposit",
    ),
    path(
        "pagar/servicio/<uuid:service_pk>/",
        views.PayServiceView.as_view(),
        name="pay_service",
    ),
    path(
        "pagar/comision/<uuid:transaction_pk>/",
        views.PayCommissionView.as_view(),
        name="pay_commission",
    ),
    ...
    path(
        "escrow/<uuid:pk>/financiar/",
        views.FundEscrowView.as_view(),
        name="fund_escrow",
    ),
    path(
        "escrow/<uuid:pk>/liberar/",
        views.ReleaseEscrowView.as_view(),
        name="release_escrow",
    ),
    path(
        "escrow/<uuid:pk>/disputar/",
        views.DisputeEscrowView.as_view(),
        name="dispute_escrow",
    ),
    path(
        "escrow/<uuid:pk>/reembolsar/",
        views.RefundEscrowView.as_view(),
        name="refund_escrow",
    ),
    # Facturas
    path("facturas/", views.InvoiceListView.as_view(), name="invoices"),
    path(
        "factura/<uuid:pk>/", views.InvoiceDetailView.as_view(), name="invoice_detail"
    ),
    path("factura/crear/", views.CreateInvoiceView.as_view(), name="create_invoice"),
    path(
        "factura/<uuid:pk>/editar/",
        views.EditInvoiceView.as_view(),
        name="edit_invoice",
    ),
    path(
        "factura/<uuid:pk>/enviar/",
        views.SendInvoiceView.as_view(),
        name="send_invoice",
    ),
    path(
        "factura/<uuid:pk>/pagar/", views.PayInvoiceView.as_view(), name="pay_invoice"
    ),
    path(
        "factura/<uuid:pk>/cancelar/",
    ...
    path(
        "plan-pago/<int:pk>/",
        views.PaymentPlanDetailView.as_view(),
        name="payment_plan_detail",
    ),
    path(
        "plan-pago/crear/",
        views.CreatePaymentPlanView.as_view(),
        name="create_payment_plan",
    ),
    path(
        "plan-pago/<int:pk>/editar/",
        views.EditPaymentPlanView.as_view(),
        name="edit_payment_plan",
    ),
    path(
        "plan-pago/<int:pk>/cancelar/",
        views.CancelPaymentPlanView.as_view(),
        name="cancel_payment_plan",
    ),
    path(
        "plan-pago/<int:pk>/pausar/",
        views.PausePaymentPlanView.as_view(),
        name="pause_payment_plan",
    ),
    path(
        "plan-pago/<int:pk>/reanudar/",
        views.ResumePaymentPlanView.as_view(),
        name="resume_payment_plan",
    ),
    ...
    path(
        "cuota/<int:pk>/pagar/",
        views.PayInstallmentView.as_view(),
        name="pay_installment",
    ),
    path(
        "cuota/<int:pk>/exonerar/",
        views.WaiveInstallmentView.as_view(),
        name="waive_installment",
    ),
    ...
    path(
        "reportes/comisiones/",
        views.CommissionReportView.as_view(),
        name="commission_report",
    ),
    path("reportes/impuestos/", views.TaxReportView.as_view(), name="tax_report"),
    # Estados de cuenta
    path(
        "estado-cuenta/", views.AccountStatementView.as_view(), name="account_statement"
    ),
    path(
        "estado-cuenta/pdf/",
        views.AccountStatementPDFView.as_view(),
        name="account_statement_pdf",
    ),
    path(
        "estado-cuenta/<int:year>/<int:month>/",
        views.MonthlyStatementView.as_view(),
    ...
    path(
        ...
        views.PaymentNotificationSettingsView.as_view(),
        name="notification_settings",
    ),
    path(
        "configuracion/recordatorios/",
        views.PaymentReminderSettingsView.as_view(),
    ...
    path(
        ...
        views.ExportTransactionsView.as_view(),
        name="export_transactions",
    ),
    path(
        "exportar/facturas/", views.ExportInvoicesView.as_view(), name="export_invoices"
    ),
    # API para AJAX
    path("api/balance/", views.BalanceAPIView.as_view(), name="api_balance"),
    path(
        "api/pending-payments/",
        views.PendingPaymentsAPIView.as_view(),
        name="api_pending_payments",
    ),
