...
class PropertyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Disponibilidad", {"fields": ("available_from", "is_featured", "is_active")}),
        (
            "Métricas",
    ...
    def mark_as_featured(self, request, queryset):
        ...
        self.message_user(
            request, f"{queryset.count()} propiedades marcadas como destacadas."
        )
    ...
    def mark_as_available(self, request, queryset):
        ...
        self.message_user(
            request, f"{queryset.count()} propiedades marcadas como disponibles."
        )
    ...
    def mark_as_rented(self, request, queryset):
        ...
        self.message_user(
            request, f"{queryset.count()} propiedades marcadas como rentadas."
        )
...
class PropertyImageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Imagen", {"fields": ("property", "image", "caption")}),
        ("Configuración", {"fields": ("is_main", "order")}),
    )
...
class PropertyAmenityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Amenidad", {"fields": ("name", "category", "description", "icon")}),
...
class PropertyInquiryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Estado y Respuesta", {"fields": ("status", "response", "responded_at")}),
    )
