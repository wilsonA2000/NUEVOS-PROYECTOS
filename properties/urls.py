...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/tour-virtual/", views.VirtualTourView.as_view(), name="virtual_tour"
    ),
    ...
    path(
        "<uuid:pk>/desactivar/",
        views.DeactivatePropertyView.as_view(),
        name="deactivate",
    ),
    # Gestión de imágenes
    path(
        "<uuid:property_pk>/imagenes/",
        views.PropertyImageManagementView.as_view(),
        name="manage_images",
    ),
    path(
        "<uuid:property_pk>/imagenes/subir/",
        views.UploadPropertyImagesView.as_view(),
        name="upload_images",
    ),
    path(
        "imagen/<int:image_pk>/eliminar/",
        views.DeletePropertyImageView.as_view(),
        name="delete_image",
    ),
    path(
        "imagen/<int:image_pk>/principal/",
        views.SetMainImageView.as_view(),
        name="set_main_image",
    ),
    # Gestión de videos
    path(
        "<uuid:property_pk>/videos/",
        views.PropertyVideoManagementView.as_view(),
        name="manage_videos",
    ),
    path(
        "<uuid:property_pk>/videos/subir/",
        views.UploadPropertyVideoView.as_view(),
        name="upload_video",
    ),
    path(
        "video/<int:video_pk>/eliminar/",
        views.DeletePropertyVideoView.as_view(),
        name="delete_video",
    ),
    # Amenidades
    path(
        "<uuid:pk>/amenidades/", views.PropertyAmenitiesView.as_view(), name="amenities"
    ),
    path(
        "<uuid:pk>/amenidades/editar/",
        views.EditPropertyAmenitiesView.as_view(),
        name="edit_amenities",
    ),
    # Consultas e interacciones
    path("<uuid:pk>/consultar/", views.PropertyInquiryView.as_view(), name="inquire"),
    path(
        "<uuid:pk>/favoritos/agregar/",
        views.AddToFavoritesView.as_view(),
        name="add_favorite",
    ),
    path(
        "<uuid:pk>/favoritos/quitar/",
    ...
    path(
        "comparar/agregar/<uuid:pk>/",
        views.AddToComparisonView.as_view(),
        name="add_to_comparison",
    ),
    path(
        "comparar/quitar/<uuid:pk>/",
        views.RemoveFromComparisonView.as_view(),
    ...
    path(
        "consultas/", views.ReceivedInquiriesView.as_view(), name="received_inquiries"
    ),
    path(
        "consulta/<int:inquiry_pk>/",
        views.InquiryDetailView.as_view(),
        name="inquiry_detail",
    ),
    path(
        "consulta/<int:inquiry_pk>/responder/",
        views.RespondInquiryView.as_view(),
    ...
    # Búsquedas guardadas
    path(
        "busquedas-guardadas/", views.SavedSearchesView.as_view(), name="saved_searches"
    ),
    path("busqueda/guardar/", views.SaveSearchView.as_view(), name="save_search"),
    path(
        "busqueda/<int:search_pk>/eliminar/",
        views.DeleteSavedSearchView.as_view(),
    ...
    path(
        "alerta/<int:alert_pk>/eliminar/",
        views.DeletePropertyAlertView.as_view(),
        name="delete_alert",
    ),
    ...
    path(
        "<uuid:pk>/exportar-pdf/",
        views.ExportPropertyPDFView.as_view(),
        name="export_pdf",
    ),
]
