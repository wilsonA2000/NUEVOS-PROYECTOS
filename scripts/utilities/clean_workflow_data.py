...
def clean_all_workflow_data():
    ...
    if match_count == 0 and doc_count == 0 and contract_count == 0 and landlord_contract_count == 0:
        print("✅ La base de datos ya está limpia. No hay datos para eliminar.")
        return

    # Confirmar acción
    confirm = input("⚠️  ¿Estás seguro de eliminar TODOS los datos de workflow? (escribe 'SI' para confirmar): ")
    if confirm != 'SI':
    ...
    print(f"   ✅ {deleted_landlord_contracts[0]} LandlordControlledContracts eliminados")
