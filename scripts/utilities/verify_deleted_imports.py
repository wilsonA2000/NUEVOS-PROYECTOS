...
def scan_imports():
    ...
    for tsx_file in base_path.rglob("*.tsx"):
        ...
        try:
            ...
            if (
                "from '../components/LoadingSpinner'" in content
                or "from './LoadingSpinner'" in content
            ):
                problems.append(
                    {
            ...
            if (
                "from './NotificationCenter'" in content
                or "from '../NotificationCenter'" in content
            ):
...
def main():
    ...
    if not problems:
        ...
        print(
            f"⚠️  ADVERTENCIA: Se encontraron {len(problems)} referencias problemáticas:"
        )
        print()
