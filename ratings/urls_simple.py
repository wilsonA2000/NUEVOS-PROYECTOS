...
urlpatterns = [
    ...
    path(
        "dada/<int:pk>/", views.RatingDetailView.as_view(), name="given_rating_detail"
    ),
    # Crear calificaciones
    path(
        "calificar/<int:user_pk>/",
        views.CreateRatingView.as_view(),
        name="create_rating",
    ),
    path(
        "calificar-usuario/<int:user_pk>/",
        views.RateUserView.as_view(),
        name="rate_user",
    ),
    path(
        "calificar-propiedad/<int:property_pk>/",
        views.RatePropertyView.as_view(),
        name="rate_property",
    ),
    path(
        "calificar-servicio/<int:service_pk>/",
        views.RateServiceView.as_view(),
        name="rate_service",
    ),
    # Invitaciones
