...
class RatingForm(forms.ModelForm):
    ...
    class Meta:
        model = Rating
        fields = ["overall_rating", "title", "review_text", "is_anonymous", "is_public"]
        widgets = {
            "overall_rating": forms.NumberInput(
                attrs={"class": "rating-input", "min": "1", "max": "10"}
            ),
            "title": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Título de tu reseña"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "description": forms.Textarea(
                attrs={
                    "class": "form-textarea",
                    "placeholder": "Explica por qué reportas esta reseña...",
                    "rows": 4,
                }
            ),
        }
